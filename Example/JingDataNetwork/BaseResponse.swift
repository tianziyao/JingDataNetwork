...
struct BaseRespHandler: JingDataNetworkResponseHandler {    
    ...
    static func makeCustomJingDataNetworkError(_ respose: String) -> JingDataNetworkError? {
        return nil
    }
    static func makeInstance(_ data: Data) throws -> String {
        return ""
    }
